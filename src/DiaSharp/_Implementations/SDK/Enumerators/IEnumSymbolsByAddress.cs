...
file unsafe partial interface InterfaceImplementation
{
	...
	{
		return ComWrappers.ComInterfaceDispatch.GetInstance<IEnumSymbolsByAddress>(__this_native).GetNext(symbolCount, symbols, out *__symbolsFetched_native__param);
	}
