...
file unsafe partial interface InterfaceImplementation : ISymbol4
{
	...
	[SkipLocalsInit]
	int ISymbol4.GetAccess(out uint result)
	{
		var(__this, __vtable_native) = ((IUnmanagedVirtualMethodTableProvider)this).GetVirtualMethodTableInfoForKey(typeof(ISymbol4));
		Unsafe.SkipInit(out result);
		int __retVal;
	...
	[SkipLocalsInit]
	int ISymbol4.GetPlatform(out uint result)
	{
		var(__this, __vtable_native) = ((IUnmanagedVirtualMethodTableProvider)this).GetVirtualMethodTableInfoForKey(typeof(ISymbol4));
		Unsafe.SkipInit(out result);
		int __retVal;
	...
	[SkipLocalsInit]
	int ISymbol4.GetLanguage(out uint result)
	{
		var(__this, __vtable_native) = ((IUnmanagedVirtualMethodTableProvider)this).GetVirtualMethodTableInfoForKey(typeof(ISymbol4));
		Unsafe.SkipInit(out result);
		int __retVal;
	...
	[SkipLocalsInit]
	int ISymbol4.GetCallingConvention(out uint result)
	{
		var(__this, __vtable_native) = ((IUnmanagedVirtualMethodTableProvider)this).GetVirtualMethodTableInfoForKey(typeof(ISymbol4));
		Unsafe.SkipInit(out result);
		int __retVal;
	...
	[SkipLocalsInit]
	int ISymbol4.GetBaseType(out uint result)
	{
		var(__this, __vtable_native) = ((IUnmanagedVirtualMethodTableProvider)this).GetVirtualMethodTableInfoForKey(typeof(ISymbol4));
		Unsafe.SkipInit(out result);
		int __retVal;
	...
	[SkipLocalsInit]
	int ISymbol4.GetIsSplitted(out bool result)
	{
		var(__this, __vtable_native) = ((IUnmanagedVirtualMethodTableProvider)this).GetVirtualMethodTableInfoForKey(typeof(ISymbol4));
		Unsafe.SkipInit(out result);
		int __result_native;
	...
	[SkipLocalsInit]
	int ISymbol4.GetCharacteristics(out uint result)
	{
		var(__this, __vtable_native) = ((IUnmanagedVirtualMethodTableProvider)this).GetVirtualMethodTableInfoForKey(typeof(ISymbol4));
		Unsafe.SkipInit(out result);
		int __retVal;
...
file unsafe partial interface InterfaceImplementation
{
	...
	{
		ISymbol4 @this = default!;
		ref int __noexcept_native = ref *__noexcept_native__param;
		...
		{
			// Unmarshal - Convert native data to managed data.
			@this = ComWrappers.ComInterfaceDispatch.GetInstance<ISymbol4>(__this_native);
			__retVal = @this.GetIsNoExcept(out noexcept);
			// Marshal - Convert managed data to native data.
			__noexcept_native = noexcept ? 1 : 0;
		}
