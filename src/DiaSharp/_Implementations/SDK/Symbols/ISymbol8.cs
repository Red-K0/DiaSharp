...
file unsafe partial interface InterfaceImplementation : ISymbol8
{
	...
	[SkipLocalsInit]
	int ISymbol8.GetIsSignedReturn(out bool isSigned)
	{
		var(__this, __vtable_native) = ((IUnmanagedVirtualMethodTableProvider)this).GetVirtualMethodTableInfoForKey(typeof(ISymbol8));
...
file unsafe partial interface InterfaceImplementation
{
	...
	{
		return ComWrappers.ComInterfaceDispatch.GetInstance<ISymbol8>(__this_native).GetCoroutineKind(out *__kind_native__param);
	}
	...
	{
		return ComWrappers.ComInterfaceDispatch.GetInstance<ISymbol8>(__this_native).GetAssociatedSymbolKind(out *__kind_native__param);
	}
	...
	{
		return ComWrappers.ComInterfaceDispatch.GetInstance<ISymbol8>(__this_native).GetAssociatedSymbolSection(out *__section_native__param);
	}
	...
	{
		return ComWrappers.ComInterfaceDispatch.GetInstance<ISymbol8>(__this_native).GetAssociatedSymbolOffset(out *__offset_native__param);
	}

	[UnmanagedCallersOnly(CallConvs = [typeof(CallConvMemberFunction)])]
	static internal int ABI_GetAssociatedSymbolRVA(ComWrappers.ComInterfaceDispatch* __this_native, uint* __rva_native__param)
	{
		return ComWrappers.ComInterfaceDispatch.GetInstance<ISymbol8>(__this_native).GetAssociatedSymbolRVA(out *__rva_native__param);
	}
	...
	{
		return ComWrappers.ComInterfaceDispatch.GetInstance<ISymbol8>(__this_native).GetAssociatedSymbolAddress(out *__address_native__param);
	}
}
