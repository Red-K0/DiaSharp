...
file unsafe partial interface InterfaceImplementation
{
	...
	{
		ISymbol5 @this = default!;
		ref int __absolute_native = ref *__absolute_native__param;
		bool absolute = default!;
		int __retVal = default;

		try
		{
			// Unmarshal - Convert native data to managed data.
			@this = ComWrappers.ComInterfaceDispatch.GetInstance<ISymbol5>(__this_native);
			__retVal = @this.GetHasAbsoluteAddress(out absolute);
			// Marshal - Convert managed data to native data.
			__absolute_native = absolute ? 1 : 0;
		}
