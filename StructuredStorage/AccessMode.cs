...
public enum AccessMode
{
	...
	/// For example, the <see cref="ISequentialStream.Read(out byte, uint, out uint)"/> method may be called, but the <see cref="ISequentialStream.Write(ref byte, uint, out uint)"/> method may not.
	/// </summary>
	Read,
	...
	/// For example, it is possible to call both <see cref="IStream.Read(out byte, uint, out uint)"/> and <see cref="IStream.Write(ref byte, uint, out uint)"/>.
	/// </summary>
	/// <remarks>
