...
/// </summary>
/// <param name="context"> The context that was passed into the call to the IDiaDataSourceEx::setPfnMiniPDBErrorCallback2 method. </param>
...
public delegate int MiniPdbErrorCallback(nint context, uint errorCode, [MarshalAs(UnmanagedType.LPWStr)] string objOrPdb, [MarshalAs(UnmanagedType.LPWStr)] string lib);